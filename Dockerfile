...
ARG TMM_URL=https://github.com/bysunexus/tinymediamanagergui/raw/master/tmm_3.1.7_linux.tar.gz
...
LABEL \
      ...
      org.label-schema.vcs-url="https://github.com/bysunexus/tinymediamanagergui" \
